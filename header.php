...
<header id="header">
    <div class="strip d-flex justify-content-between px-4 py-1 bg-light">
        <p class="font-raleway font-size-12 text-black-50 m-0">1600 Pennsylvania Avenue NW, Washington, DC 20500, United States</p>
        <div class="font-raleway font-size-14">
            <a href="" class="px-3 border-right border-left text-dark">Login</a>
            <a href="" class="px-3 border-right border-left text-dark">Wish list (0)</a>
        </div>
    </div>
    <!-- Primary navigation -->
